					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="card">
							<div class="header">
								...
								<h2 class="card-inside-title">ADD CATEGORY DETAILS</h2>

							</div>
							<div class="body">

								<form name="categoryForm" ng-submit="submitSubCategory()">
									<div class="row clearfix">
										<div class="col-md-4">
											...
											<div class="input-group spinner" data-trigger="spinner">
												<div class="form-line">
													<input type="text" class=""
														ng-model="subCategoryName" id="subCategoryName">
												</div>
							...
							<div class="body">
								<div class="table-responsive">
									<table id="jobListTable"
										...
										<tbody>
											<tr ng-repeat="subcategory in categories">
